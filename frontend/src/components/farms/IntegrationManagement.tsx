...
interface IntegrationManagementProps {
  ...
  onUpdateIntegration: (farmId: number, integrationData: { integration_type: 'none' | 'rotem' | 'future_system'; rotem_farm_id?: string; rotem_username?: string; rotem_password?: string; rotem_gateway_name?: string; rotem_gateway_alias?: string; program_id?: number }) => Promise<void>;
