...
urlpatterns = [
    ...
    path('houses/<int:house_id>/monitoring/trends/', views.house_monitoring_trends, name='house-monitoring-trends'),
    path('farms/<int:farm_id>/monitoring/data-quality/', views.farm_data_quality, name='farm-data-quality'),
    path('houses/<int:house_id>/flock-risk-scores/', views.house_flock_risk_scores, name='house-flock-risk-scores'),
